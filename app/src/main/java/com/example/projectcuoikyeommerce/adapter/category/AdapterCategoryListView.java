...
public class AdapterCategoryListView extends RecyclerView.Adapter<AdapterCategoryListView.ViewHolder> {
    private CateGoryGridViewEvent cateGoryGridViewEvent;
    private List<Product> productList;

    public AdapterCategoryListView(CateGoryGridViewEvent cateGoryGridViewEvent, List<Product> productList) {
